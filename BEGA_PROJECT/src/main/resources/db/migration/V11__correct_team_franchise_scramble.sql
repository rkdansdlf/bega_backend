-- Correcting the scrambled team_franchises and teams data
-- V10 used an incorrect mapping of IDs to team names. This script fixes it based on actual DB state.

-- 1. Fix team_franchises current_code and original_code to match their NAME
-- Based on: ID 1:한화, 2:KIA, 3:KT, 4:LG, 5:롯데, 6:NC, 7:두산, 8:삼성, 9:SSG, 10:키움

...
@Slf4j
public class AiSeatViewClassificationAdapter implements SeatViewClassificationPort {
        ...
        try {
            ...
            try {
                ...
                if (exception.getStatusCode().value() == HttpStatus.NOT_FOUND.value()) {
                    log.warn("Primary seat-view AI endpoint not found, fallback to legacy path. cause={}",

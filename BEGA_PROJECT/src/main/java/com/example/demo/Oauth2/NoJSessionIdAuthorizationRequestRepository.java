...
public class NoJSessionIdAuthorizationRequestRepository implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
        ...
        if (setCookieHeaders != null && !setCookieHeaders.isEmpty()) {
            ...
            for (String header : setCookieHeaders) {
                if (header.contains(JSESSIONID)) {
                    ...
                    response.addHeader("Set-Cookie", JSESSIONID + "=deleted; Path=/; Max-Age=0; Expires=Thu, 01 Jan 1970 00:00:00 GMT; HttpOnly");
                } else {

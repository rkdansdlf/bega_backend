...
@EnableJpaRepositories(
		...
		excludeFilters = {
				...
				@ComponentScan.Filter(
						type = org.springframework.context.annotation.FilterType.REGEX,
						pattern = "com\\.example\\.kbo\\.repository\\.(GameRepository|GameMetadataRepository|GameInningScoreRepository|GameSummaryRepository|GameEventRepository|GamePlayByPlayRepository|PlayerSeasonBattingRepository|PlayerSeasonPitchingRepository)"
				)
		}
)

...
public class BegaGameService {
	...
	private GameResponseDto convertToDto(BegaGame game) {
		...
		String homeTeamName = TEAM_KOREAN_NAME_MAP.getOrDefault(game.getHomeTeam(), game.getHomeTeam());
		String awayTeamName = TEAM_KOREAN_NAME_MAP.getOrDefault(game.getAwayTeam(), game.getAwayTeam());
		String stadiumName = STADIUM_FULL_NAME_MAP.getOrDefault(game.getStadium(), game.getStadium());

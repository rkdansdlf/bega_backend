...
class KboGamePostgresJpaConfigTest {
    ...
    void resolveRelaxedSchema_prefersPublicWhenCanonicalTablesExist() {
        ...
        JdbcTemplate jdbcTemplate = mockJdbcTemplate(Map.ofEntries(
                entry("public:game", 1),
                entry("public:game_metadata", 1),
                entry("public:game_summary", 1),
                entry("public:game_inning_scores", 1),
                entry("public:game_events", 1),
                entry("public:game_play_by_play", 1),
                entry("security:game", 1),
                entry("security:game_metadata", 1),
                entry("security:game_summary", 1),
                entry("security:game_inning_scores", 1),
                entry("security:game_events", 1),
                entry("security:game_play_by_play", 1)
        ));
    ...
    void resolveRelaxedSchema_keepsActiveSchemaWhenPublicIncomplete() {
        ...
        JdbcTemplate jdbcTemplate = mockJdbcTemplate(Map.ofEntries(
                ...
                entry("public:game_metadata", 1),
                entry("public:game_summary", 1),
                entry("public:game_inning_scores", 0),
                entry("public:game_events", 1),
                entry("public:game_play_by_play", 1),
                entry("security:game", 1),
                entry("security:game_metadata", 1),

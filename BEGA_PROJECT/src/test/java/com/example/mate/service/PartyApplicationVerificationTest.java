...
class PartyApplicationVerificationTest {
    ...
    class ServerSideBadgeResolution {
        ...
        void shouldSetVerifiedBadgeWithValidToken() {
            ...
            verify(applicationRepository).save(argThat(app -> app.getApplicantBadge() == Party.BadgeType.VERIFIED &&
        ...
        void shouldIgnoreClientVerifiedBadge() {
            ...
            verify(applicationRepository).save(argThat(app -> app.getApplicantBadge() == Party.BadgeType.NEW));
        }
        ...
        void shouldAutoAssignTrustedBadge() {
            ...
            verify(applicationRepository).save(argThat(app -> app.getApplicantBadge() == Party.BadgeType.TRUSTED));
        }
    }
